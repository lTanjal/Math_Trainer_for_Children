...
import { Image as EmailImg } from "@rneui/themed";
import EStyleSheet from "react-native-extended-stylesheet";
import { Button, Icon } from "@rneui/themed";
import SendEmail from "./Email";

export default function Home({ navigation }) {
  const { emailAvailability } = SendEmail();
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#ffffff" }}>
        ...
        >
          ...
          >
            ...
            <Text style={styles.system}>
              Translate my words in other language
            </Text>
            <Text style={styles.blockText}>
              {" "}
              Here, you can translate unfamiliar words or entire sentences
              between different languages. Type your text and the translation
              will appear in the nearby window. Happy discovering!
            </Text>
            <Button
              type="outline"
              buttonStyle={styles.buttonStyle}
      ...
      >
        <EmailImg
          style={[styles.emailImageStyle, { transform: [{ rotate: "5deg" }] }]}
